...
; SYSMSG displays "SpeedScript 3.1".
...
CTBL        .BYTE   39
            ...
            .BYTE   10,141,7
VECT        .WOR    RIGHT-1,LEFT-1,WLEFT-1,WRIGHT-1,BORDER-1,LETTERS-1
            .WOR    SLEFT-1,SRIGHT-1,DELCHAR-1,INSCHAR-1,DELETE-1
            .WOR    HOME-1,INSTGL-1,CLEAR-1,PARIGHT-1,PARLEFT-1
            .WOR    ERAS-1,TLOAD-1,TSAVE-1,VERIFY-1
            .WOR    SLEFT-1,SRIGHT-1,CATALOG-1,INSBUFFER-1,SWITCH-1
            .WOR    ENDTEX-1,PRINT-1,FORMAT-1,DCMND-1
            .WOR    DELIN-1,ALPHA-1,KILLBUFF-1,HUNT-1,FREEMEM-1,TAB-1
            .WOR    LOTTASPACES-1,REPSTART-1,ENDPAR-1,SANDR-1
...
; command.
SPTAB       .BYTE   18
            .ASC    "WALRTBSNHF@P?XMIGJ"

; The address-1 of each format routine.
SPVECT      .WOR    PW-1,AS-1,LM-1,RM-1,TP-1
            .WOR    BT-1,SP-1,NX-1,HD-1,FT-1
            .WOR    PN-1,PL-1,SPAGE-1,ACROSS-1
            .WOR    MRELEASE-1,COMMENT-1,LINK-1
            .WOR    LFSET-1
...
ymsg        .asc    ": Are you sure?
                    (Y/N):"
            .byte   0
clrmsg      .asc    "ERASE ALL TEXT"
            .byte   0
erasmsg     .asc    "Erase (S,W,P): "
            .byte   18
            .asc    "RETURN"
            .byte   146
            .asc    " to exit"
...
prinmsg     .byte   147
            .asc    "Printing..."
            .byte   13,13,0
waitmsg     .asc    "Insert next sheet, press "
            .byte   18
            .asc    "RETURN"
            .byte   146,0
...
POS         *=      *+1     ;POSition within the line
LINE        *=      *+1     ;Line count
